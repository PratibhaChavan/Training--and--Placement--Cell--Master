...
if(isset($_POST['submit']))
{
	...
	if ($conn->connect_error)die($conn->connect_error) ;
		...
		$mobile=$_POST['mobile'];
		$dob=$_POST['dob'];
		$query=" UPDATE studentregistration  SET `password`='$student_password',`email`='$email',`branch`='$branch',`percent`='$percent',`passyear`='$year',`address`='$address',`mobileno`=$mobile,`dob`='$dob' WHERE username='$student_name'";
...
<div class="login-box">
	<img src="student.png" class="student">
		...
		<form name="studentregistration"method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
			...
			<td align="right"><a href="studentlogin.php"><input type="submit" id="submit" name="submit" value="Update "align="right" ></a></td></tr>
			</table>
		</form>
