...
<body>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of SHHJB Poly</h3>
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>The Institute offers diploma courses in 4 disciplines in Engineering viz. Computer Technology Engineering,  Electronics and communication, Civil Engineering, Mechanical Engineering.
					</p>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>Shri H.H.J.B.Polytechnic,Chandawad
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Shri H.H.J.B.Polytechnic Institute</h6>
					<h4>
						<a href="../Homepage/index.php" style="color: white">Training and Placement Management System</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
