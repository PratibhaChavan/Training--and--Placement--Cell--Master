				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">SHHJB-Polytechnic Institute<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">SHHJB Polytechnic Institute</h6>
					<h4>
